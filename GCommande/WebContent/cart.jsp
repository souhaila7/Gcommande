...
<body>
		...
		<c:forEach items="${cartlist }" var="i">
			...
			<table style="table-layout: fixed;width: 100%;">
				<tr>
					...
					<td style="width: 100px;"><a href="Controller?page=remove&id=<c:out value="${Product.getId()}"/>"><span class="btn btn-danger">Delete</span></a></td>
				</tr>
			</table>
				</c:if>
			</c:forEach>
	...
	<h4 style="margin-top: 40px;margin-bottom: 40px;">Order Total: &euro;; (<c:out value="${ total}"></c:out>)</h4>
	
	<a href="Controller?page=success"><input type="submit" value="Proceed to Checkout" class="btn btn-success" style="width:100%;padding:8px;font-size:16px;background-color: fuchsia;;;"></a><br>
	<a href="Controller?page=index"><input type="button" value="Continue Shopping" class="btn btn-warning" style="width:100%;padding:8px;font-size:16px;background-color: #337ab7;"></a>
	
	
	</div>

	<footer style="margin-top: 40px;">
		<div class="footer" style="background-color: #337ab7;"> &copy; 2021 Copyright
	    </div>
	</footer>
