	...
	<header style="background-color: #337ab7;">
		...
		<nav>
			<ul>
				...
				<li><a href="Controller?page=showcart">card(<c:out value="${x}"/>)</a></li>
			</ul>
		</nav>
	</header>
 	...
 	<div class="container">
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
						 ...
						 <a href="Controller?page=all-products" class="list-group-item" style="color:white; background:  #F08080;">
						    Categories
						  </a>
						  <a href="Controller?page=mobiles" class="list-group-item" style="background:  aqua;">Mobiles</a>
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'mobiles' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<p style="text-align: center;"> &euro;  <c:out value="${ product.getPrice() }"></c:out></p>
