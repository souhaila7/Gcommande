	...
	<div class="signup-header" style="background-color: #337ab7;">
	 ...
	 <input type="hidden" name="page" value="sign-up-form">
	 	...
	 	<div class="signup-group">
	 		<label>Name</label>
	 		<input type="text" name="name" placeholder="Name" value="<c:out value="${name }"></c:out>" required>
	 	</div>
	 	<div class="signup-group">
	 		<label>Email</label>
	 	...
	 	<p>
	 		Already have an account? <a href="Controller?page=login" style="color:#cf306c;">Login!</a>
	 	</p>
	 </form>
	<br><br><br>
	<footer>
